          ...
          {[
            {
              ...
              gradient: "from-[#D1AB6D] via-[#525E2C] to-[#E0CFB5]",
              image: "/Details/St. Joseph the Patriarch Parish.jpg",
            },
            {
              key: "reception",
              label: "Reception",
              ...
              gradient: "from-[#525E2C] via-[#909E8D] to-[#F0F0EE]",
              image: "/Details/Golden Peak Hotel & Suites.jpg",
            },
          ].map((info) => (
            <div
              key={info.key}
            ...
            >
              ...
              <div className="relative h-52 sm:h-64 md:h-72 w-full">
                <Image
                  ...
                  priority
                />
                <div className={`absolute inset-0 bg-gradient-to-t from-[#D1AB6D]/95 via-[#525E2C]/65 to-transparent`} />
              ...
              {/* Details panel */}
              <div className="bg-[#F0F0EE]/95 text-[#D1AB6D] px-3 sm:px-6 py-4 sm:py-6 space-y-4 backdrop-blur-sm">
                <div className="space-y-2.5">
                  <div className="space-y-1">
                    <p className="text-xs sm:text-sm text-[#D1AB6D]/90 leading-relaxed">{info.location}</p>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2 text-left">
                    <div className="rounded-md border border-[#E0CFB5] bg-white/80 px-2.5 py-2 shadow-sm">
                      <p className="text-[9px] sm:text-[10px] font-semibold tracking-[0.18em] text-[#525E2C] uppercase mb-0.5">
                        {info.key === "ceremony" ? "Date & Time" : "Time"}
                      </p>
                      <p className="text-sm sm:text-base font-bold text-[#D1AB6D]">
                        {info.key === "ceremony" 
                    ...
                    <div className="rounded-md border border-[#E0CFB5] bg-white/80 px-2.5 py-2 shadow-sm">
                      ...
                      <p className="text-sm sm:text-base font-bold text-[#D1AB6D]">{info.venue}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 rounded-lg border border-[#525E2C]/35 text-[#D1AB6D] py-2.5 sm:py-3 hover:bg-[#525E2C]/5 transition-all text-xs sm:text-sm font-semibold"
                  >
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="relative rounded-2xl border border-white/40 bg-white/85 backdrop-blur-lg shadow-[0_18px_40px_rgba(210,164,164,0.18)] p-3.5 sm:p-5 overflow-hidden">
            <div className="mb-2.5 sm:mb-3 relative z-10 text-center">
              <h4 className="text-[0.75rem] sm:text-sm md:text-base font-semibold tracking-[0.3em] uppercase text-[#D1AB6D]">
                Attire &amp; Motif
              </h4>
            </div>
            ...
            <div className="relative w-full rounded-2xl overflow-hidden border border-white/60 shadow-xl bg-white p-4 sm:p-6 space-y-3 sm:space-y-4">
              <div className="text-center space-y-2 sm:space-y-3">
                <p className="text-xs sm:text-sm font-semibold text-[#D1AB6D]">
                  {siteConfig.dressCode.note}
                </p>
                <p className="text-xs sm:text-sm text-[#D1AB6D]/90">
              ...
              <div className="space-y-4">
                <div className="border-t border-[#E0CFB5] pt-4">
                  <h5 className="font-semibold text-xs sm:text-sm text-[#D1AB6D] mb-2">Principal Sponsors</h5>
                  ...
                  <div className="relative w-full aspect-[4/3] sm:aspect-[5/3] rounded-xl overflow-hidden border border-[#F5E5D9] bg-[#FDF9F6] mb-3">
                    <Image
                      src="/Details/Gemini_Generated_Image_ae29zpae29zpae29-removebg-preview.png"
                  ...
                  <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                    <p className="text-[#D1AB6D]">
                      <span className="font-semibold">Ladies:</span> Sage Green gown / long dress
                    </p>
                    <p className="text-[#D1AB6D]">
                      <span className="font-semibold">Gentlemen:</span> Black suit and tie
                    </p>
                    <div className="pt-1">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] text-[#D1AB6D] mb-1">
                        Palette
                      </p>
                ...
                <div className="border-t border-[#F5E5D9] pt-4">
                  <h5 className="font-semibold text-xs sm:text-sm text-[#D1AB6D] mb-2">Wedding Guests</h5>
                  <p className="text-[10px] sm:text-xs text-[#D1AB6D]/80 mb-2">Kindly align attire below.</p>
                  <div className="relative w-full aspect-[4/3] sm:aspect-[5/3] rounded-xl overflow-hidden border border-[#F5E5D9] bg-[#FDF9F6] mb-3">
                    <Image
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="relative w-full rounded-2xl overflow-hidden border border-white/60 shadow-xl bg-white p-4 sm:p-6">
                <div className="mb-3 sm:mb-4">
                  <h4 className="text-[0.75rem] sm:text-sm md:text-base font-semibold tracking-[0.3em] uppercase text-[#D1AB6D] mb-3">
                    Arrival Time
                  </h4>
                  <div className="space-y-2 sm:space-y-2.5">
                    <p className="text-xs sm:text-sm text-[#D1AB6D] leading-relaxed">
                      Kindly arrive by <span className="font-semibold text-[#525E2C]">{siteConfig.ceremony.guestsTime}</span> so we can begin the wedding ceremony promptly at exactly <span className="font-semibold text-[#525E2C]">{siteConfig.ceremony.time}</span>.
                    </p>
                    <p className="text-xs sm:text-sm text-[#D1AB6D] leading-relaxed">
          ...
          <div className="relative rounded-2xl border border-[#E0CFB5]/70 bg-[#F0F0EE]/90 backdrop-blur-lg shadow-[0_18px_40px_rgba(210,164,164,0.18)] p-3.5 sm:p-5 overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-center gap-2 mb-2.5 sm:mb-3 relative z-10">
              <div className="p-1.5 rounded-full shadow-md bg-white/95 border border-[#E0CFB5]/60">
                <Car className="w-3.5 h-3.5 text-[#525E2C]" />
              </div>
              <h4 className="font-semibold text-xs sm:text-base text-[#D1AB6D]">Parking &amp; Travel</h4>
            </div>
            ...
            <div className="space-y-3 relative z-10">
              ...
              <div className="rounded-xl p-2.5 sm:p-3 border border-[#E0CFB5]/80 bg-gradient-to-br from-white/95 via-[#F0F0EE]/95 to-white/90 shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[11px] sm:text-sm font-semibold text-[#D1AB6D]">Parking Available</p>
                    <p className="text-[10px] sm:text-xs text-[#D1AB6D]/85">
              ...
              <div className="rounded-xl p-2.5 sm:p-3 border border-[#E0CFB5]/80 bg-gradient-to-br from-white/95 via-[#F0F0EE]/95 to-white/90 shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[11px] sm:text-sm font-semibold text-[#D1AB6D]">Transportation</p>
                    <p className="text-[10px] sm:text-xs text-[#D1AB6D]/85">
              ...
              {/* Tips */}
              <div className="rounded-xl p-2.5 sm:p-3 border border-[#E0CFB5]/75 bg-gradient-to-br from-white/95 via-[#F0F0EE]/95 to-white/90">
                <p className="text-[11px] sm:text-sm font-semibold mb-2 flex items-center gap-2 text-[#D1AB6D]">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#525E2C]/10 text-[#525E2C]">
                    <MapPin className="w-3.5 h-3.5" />
                  </span>
                  Quick Tips
                </p>
                <ul className="text-[10px] sm:text-xs space-y-1 text-[#D1AB6D]/90">
        ...
        >
          ...
          >
            ...
            >
              ...
              <Image
                src={showImageModal === "ceremony" ? "/Details/St. Joseph the Patriarch Parish.jpg" : "/Details/Golden Peak Hotel & Suites.jpg"}
